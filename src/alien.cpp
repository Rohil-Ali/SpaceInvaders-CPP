...
Alien::Alien(int type, Vector2 position)
{
    ...
    //check to see if alienlimages array is empty, if it is then an image is put into the array. the array prevents the need to load the image from disk 55 times. 
